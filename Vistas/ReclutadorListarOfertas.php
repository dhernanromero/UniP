...
<head>
	...
	<script src="../js/ListaOfertasReclutadores.js" language="javascript" type="text/javascript" ></script>
</head>
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
			  ...
			  <li class="nav-item">
            	<a class="nav-link text-white" href="#">Mis Ofertas</a>
          	  </li>
              <li class="nav-item">
					...
					<?php
						foreach ($listaReclutadores as $row) {
							...
							<tr class="table-active">
								...
								<td>
								<a href="DetalleOfetaLaboral.php?Id='.$row['IdOferta'].'" class="link-dark float-end btn btn-primary text-white mb-2 mt-4 ">Ver oferta</a>
								</td>
						</tr>
							');
						}
